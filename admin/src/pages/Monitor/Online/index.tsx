  ...
  const columns: ProColumns<API.Monitor.OnlineUserType>[] = [
    {
      title: (
        <FormattedMessage
          id='monitor.online.user.token_id'
          defaultMessage='会话编号'
        />
      ),
      dataIndex: 'tokenId',
    ...
    },
    {
      title: (
        <FormattedMessage
          id='monitor.online.user.user_name'
          defaultMessage='用户账号'
        />
      ),
      dataIndex: 'userName',
    ...
    },
    {
      title: (
        <FormattedMessage
          id='monitor.online.user.dept_name'
          defaultMessage='部门名称'
        />
      ),
      dataIndex: 'deptName',
    ...
    },
    {
      title: (
        <FormattedMessage
          id='monitor.online.user.login_location'
          defaultMessage='登录地点'
        />
      ),
    ...
    },
    {
      title: (
        <FormattedMessage
          id='monitor.online.user.browser'
    ...
    },
    {
      title: (
        <FormattedMessage
          id='monitor.online.user.login_time'
          defaultMessage='登录时间'
        />
      ),
      dataIndex: 'loginTime',
