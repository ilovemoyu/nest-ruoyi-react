  ...
  const columns: ProColumns<API.Monitor.JobLog>[] = [
    {
      title: (
        <FormattedMessage
          id='monitor.job.log.job_log_id'
          defaultMessage='任务日志编号'
        />
      ),
      dataIndex: 'jobLogId',
      valueType: 'text',
    ...
    },
    {
      title: (
        <FormattedMessage
          id='monitor.job.log.invoke_target'
    ...
    },
    {
      title: (
        <FormattedMessage
          id='monitor.job.log.job_message'
          defaultMessage='日志信息'
        />
      ),
    ...
    },
    {
      title: (
        <FormattedMessage
          id='monitor.job.log.create_time'
          defaultMessage='异常信息'
        />
      ),
