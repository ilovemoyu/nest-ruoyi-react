...
const DictDataTableList: React.FC = () => {
  ...
  const columns: ProColumns<API.System.DictData>[] = [
    ...
    {
      title: (
        <FormattedMessage id='system.dict.data.status' defaultMessage='状态' />
      ),
      dataIndex: 'status',
      valueType: 'select',
    ...
    {
      title: (
        <FormattedMessage id='system.dict.data.remark' defaultMessage='备注' />
      ),
      dataIndex: 'remark',
      valueType: 'textarea',
      hideInSearch: true,
    },
    {
      title: (
        <FormattedMessage
          id='system.dict.data.create_time'
          defaultMessage='创建时间'
        />
      ),
