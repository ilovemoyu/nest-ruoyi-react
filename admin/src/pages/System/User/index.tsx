...
const UserTableList: React.FC = () => {
  ...
  const [selectDept, setSelectDept] = useState<any>({ id: 100 })
  ...
  const columns: ProColumns<API.System.User>[] = [
    {
      title: (
        <FormattedMessage id='system.user.user_id' defaultMessage='用户编号' />
      ),
      dataIndex: 'userId',
      valueType: 'text',
    },
    ...
    {
      title: (
        <FormattedMessage id='system.user.dept_name' defaultMessage='部门' />
      ),
              ...
              <Button
                ...
                onClick={async () => {
                  ...
                  if (postResp.code === 200) {
                    setPostList(
                      postResp.data.list.map((item: any) => {
                        return {
                          value: item.postId,
                          label: item.postName,
                        }
                  ...
                  if (roleResp.code === 200) {
                    setRoleList(
                      roleResp.data.list.map((item: any) => {
                        return {
                          value: item.roleId,
                          label: item.roleName,
                        }
