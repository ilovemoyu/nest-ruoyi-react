    ...
    <div className='iconPicSearcher'>
      <Popover
        content={formatMessage({
          id: 'app.docs.components.icon.pic-searcher.intro',
        })}
      ...
      >
        ...
        {state.modelLoaded && (
          ...
          >
            ...
            <p className='ant-upload-text'>
              {formatMessage({
                id: 'app.docs.components.icon.pic-searcher.upload-text',
              })}
            </p>
            <p className='ant-upload-hint'>
              {formatMessage({
                id: 'app.docs.components.icon.pic-searcher.upload-hint',
              })}
            </p>
          </Dragger>
        )}
        <Spin
          ...
          tip={formatMessage({
            id: 'app.docs.components.icon.pic-searcher.matching',
          })}
        >
          <div className='icon-pic-search-result'>
            {state.icons.length > 0 && (
              <div className='result-tip'>
                {formatMessage({
                  id: 'app.docs.components.icon.pic-searcher.result-tip',
                })}
              </div>
            )}
            <table>
                ...
                <thead>
                  <tr>
                    <th className='col-icon'>
                      {formatMessage({
                        id: 'app.docs.components.icon.pic-searcher.th-icon',
                      })}
                    </th>
                    <th>
                      {formatMessage({
                        id: 'app.docs.components.icon.pic-searcher.th-score',
                      })}
                    </th>
                  </tr>
                </thead>
