...
import { CreateDictTypeDto, UpdateDictTypeDto, ListDictType, CreateDictDataDto, UpdateDictDataDto, ListDictData } from './dto';
...
export class DictService {
  ...
  async createType(createDictTypeDto: CreateDictTypeDto) {
    createDictTypeDto.createTime = new Date();
